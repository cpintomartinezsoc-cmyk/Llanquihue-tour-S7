...
Esta clase sirve como base para todas las categorías de servicios turísticos.
...
Gracias al polimorfismo, cada objeto ejecuta automáticamente la versión correspondiente de dicho método según su tipo.
